...
export const Footer = () => {
  ...
  return (
    <footer className="relative mt-16">
      <div className="absolute inset-0 bg-gradient-to-r from-[#DF6D14]/10 via-[#9DC08B]/10 to-[#DF6D14]/10" />
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="py-8 flex justify-center space-x-6">
          <a
            ...
            className="text-gray-600 dark:text-gray-400 hover:text-[#DF6D14] dark:hover:text-[#9DC08B] transition-colors"
            aria-label="GitHub"
          >
